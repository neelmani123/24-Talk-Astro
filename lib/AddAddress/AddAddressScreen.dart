...
class _AddAddressState extends State<AddAddress> {
  ...
  Future getAddress() async
  {
    ...
    var response=await http.post("https://talkastro.devclub.co.in/userapi/address_list",headers: headers,body: res);
        ...
        appBar: AppBar(
          ...
          actions: [
            IconButton(icon: Icon(Icons.add), onPressed: (){
               Navigator.push(context, MaterialPageRoute(builder: (ctx) => NewAddress()));
            }),
          ],
        ),
        /*body: Column(
                     ...
                     child: Container(
                       ...
                       child: Row(
                        children: [
                          ...
                          Spacer(),
                          Radio(
                            value: 0, groupValue:selectedRadio,
                            onChanged: (val){
                            setState(() {
                              selectedRadio=val;
                            });
