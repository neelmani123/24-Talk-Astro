...
import 'package:online_astro24/Widgets/googleMapScreen.dart';
import 'package:online_astro24/utils/setup.dart';

import 'HoroscopeScreen/SignDetailsScreen.dart';
...
class Demo extends StatefulWidget {
  ...
  const Demo({Key key, this.drawerKey}) : super(key: key);
              ...
              child: ListView.builder(
                ...
                itemBuilder: (ctx, i) => Container(
                  child: InkWell(
                    onTap: () {
                      Navigator.pushNamed(
                          context, SignDetailsScreen.signDetailScreen);
                    },
                    child: Container(
                      child: Column(
                        children: [
